...
gden(gotmarr.stat)
gtrans(gotmarr.stat)
igraph::components(gotmarr.ig)$no
summary(gotmarr.stat%e%"weight")

gden(gotmarr.stat)
gtrans(gotmarr.stat)
igraph::components(gotpart.ig)$no
summary(gotpart.stat%e%"weight")
...
print(head(gotmarr.nodes), digits=2) #to see your dataframe
...
print(head(gotpart.nodes), digits=2) #to see your dataframe
...
#got partners
plot(gotpart.se,labels=gotpart.se$glabels)
rect.hclust(gotpart.se$cluster,h=3.5)

#monks
plot(monks.se,labels=monks.se$glabels)
rect.hclust(monks.se$cluster,h=13)
```
