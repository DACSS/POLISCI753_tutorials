...
### Inspect basic network descriptors
...
Inspect the dyads, triads, and component structure of the `airports.fl.stat` and `airports.geo.stat` networks. Pay attention to whether network is connected, as it affects the options you use for closeness centrality.
...
```{r nodes-solution}
alliances.nodes <- data.frame(
  name = alliances.stat %v% "vertex.names",
...
alliances.nodes <-
  full_join(alliances.nodes, get.eigen(alliances.stat), by = "name")

airports.fl.nodes <-
  data.frame(
    name = airports.fl.stat %v% "vertex.names",
...
airports.fl.nodes <-
  full_join(airports.fl.nodes, get.eigen(airports.fl.stat), by = "name")

airports.geo.nodes <-
  data.frame(
    name = airports.geo.stat %v% "vertex.names",
...
airports.geo.nodes <-
  full_join(airports.geo.nodes, get.eigen(airports.geo.stat), by = "name")
...
flomarr.nodes <-
  full_join(flomarr.nodes, get.eigen(flomarr.stat), by = "name")
...
print(blockmodel(flomarr.stat, comm.fg$membership)$block.model,
      digits = 2)
```
...
```{r density-solution}
#Inspect density within and between communities
print(blockmodel(gotmarr.stat, got.fg$membership)$block.model,
      digits = 2)

#alliances
print(blockmodel(alliances.stat, alliances.fg$membership)$block.model,
      digits = 2)
#airport flights
print(blockmodel(airports.fl.stat, airports.fl.fg$membership)$block.model,
      digits = 2)
#airport distance
print(blockmodel(airports.geo.stat, airports.geo.fg$membership)$block.model,
      digits = 2)
```
...
Because we will be repeating the same steps multiple times this week, let's create a custom function to summarize the node statistics by community group.
...
The community object can be used in the various steps introduced earlier. Let's inspect density of ties within and between communities, and the characteristics of nodes in each community.

```{r}
#inspect density of between/within community ties
print(blockmodel(flomarr.stat, comm.wt$membership)$block.model,
      digits = 2)
...
#inspect density of between/within community ties
print(blockmodel(gotmarr.stat, got.wt$membership)$block.model,
      digits = 2)
#add community membership as a vertex attribute
...
print(blockmodel(alliances.stat, alliances.wt$membership)$block.model,
      digits = 2)
...
print(blockmodel(airports.fl.stat, airports.fl.wt$membership)$block.model,
      digits = 2)
...
print(blockmodel(airports.geo.stat, airports.geo.wt$membership)$block.model,
      digits = 2)
...
As expected, the partition produced by the fast, greedy algorithm is characterized by a higher modularity score than the one produced by the walktrap algorithm. This is expected because the goal of fast, greedy is to optimize modularity. But would you agree that the resulting partition is necessarily superior to the community partition produced by walktrap?
...
compare.algs <-
  function(alg.a,
           alg.b,
           compare.meth = c("vi", "nmi", "split.join", "rand", "adjusted.rand")) {
...
#alliances
alliances.mods <-
  c(fastgreedy = modularity(alliances.fg),
    walktrap = modularity(alliances.wt))
alliances.mods
#compare community partitions
...
#airports.flights
mods <-
  c(fastgreedy = modularity(airports.fl.fg),
    walktrap = modularity(airports.fl.wt))
mods
#compare community partitions
...
#airports.geograph
mods <-
  c(fastgreedy = modularity(airports.geo.fg),
    walktrap = modularity(airports.geo.wt))
mods
#compare community partitions
...
```{r}
#inspect density of between/within community ties
print(blockmodel(flomarr.stat, comm.lab$membership)$block.model,
      digits = 2)
#add community membership as a vertex attribute
...
#inspect density of between/within community ties
print(blockmodel(gotmarr.stat, got.lab$membership)$block.model,
      digits = 2)
#add community membership as a vertex attribute
...
print(blockmodel(alliances.stat, alliances.lab$membership)$block.model,
      digits = 2)
...
mods <- c(mods, label = modularity(comm.lab))
mods
compare.algs(alg.a = c("alliances.fg", "alliances.wt"),
             alg.b = "alliances.lab")

#airport flights
airports.fl.lab <- walktrap.community(airports.fl.ig)
igraph::groups(airports.fl.lab)
print(blockmodel(airports.fl.stat, airports.fl.lab$membership)$block.model,
      digits = 2)
...
mods <- c(mods, label = modularity(comm.lab))
mods
compare.algs(alg.a = c("airports.fl.fg", "airports.fl.wt"),
             alg.b = "airports.fl.lab")

#airport geography
airports.geo.lab <- walktrap.community(airports.geo.ig)
igraph::groups(airports.geo.lab)
print(blockmodel(airports.geo.stat, airports.geo.lab$membership)$block.model,
      digits = 2)
...
mods <- c(mods, label = modularity(comm.lab))
mods
compare.algs(alg.a = c("airports.geo.fg", "airports.geo.wt"),
             alg.b = "airports.geo.lab")
...
```{r}
#inspect density of between/within community ties
print(blockmodel(flomarr.stat, comm.edge$membership)$block.model,
      digits = 2)
#add community membership as a vertex attribute
...
mods
#compare community partitions
compare.algs(alg.a = c("comm.fg", "comm.wt", "comm.lab"),
             alg.b = "comm.edge")
```
...
#inspect density of between/within community ties
print(blockmodel(gotmarr.stat, got.edge$membership)$block.model,
      digits = 2)
#add community membership as a vertex attribute
...
mods
#compare community partitions
compare.algs(alg.a = c("got.fg", "got.wt", "got.lab"),
             alg.b = "got.edge")

#alliances
alliances.edge <- edge.betweenness.community(alliances.ig)
igraph::groups(alliances.edge)
print(blockmodel(alliances.stat, alliances.edge$membership)$block.model,
      digits = 2)
...
mods
compare.algs(
  alg.a = c("alliances.fg", "alliances.wt", "alliances.lab"),
  alg.b = "alliances.edge"
)

#airport flights
airports.fl.edge <- edge.betweenness.community(airports.fl.ig)
igraph::groups(airports.fl.edge)
print(blockmodel(airports.fl.stat, airports.fl.edge$membership)$block.model,
      digits = 2)
...
mods
compare.algs(
  alg.a = c("airports.fl.fg", "airports.fl.wt", "airports.fl.lab"),
  alg.b = "airports.fl.edge"
)

#airport geography
airports.geo.edge <- edge.betweenness.community(airports.geo.ig)
igraph::groups(airports.geo.edge)
print(blockmodel(airports.geo.stat, airports.geo.edge$membership)$block.model,
      digits = 2)
...
mods
compare.algs(
  alg.a = c("airports.geo.fg", "airports.geo.wt", "airports.geo.lab"),
  alg.b = "airports.geo.edge"
)
...
```{r}
#inspect density of between/within community ties
print(blockmodel(flomarr.stat, comm.eigen$membership)$block.model,
      digits = 2)
#add community membership as a vertex attribute
...
compare.algs(alg.a = c("comm.fg", "comm.wt", "comm.lab", "comm.edge"),
             alg.b = "comm.eigen")
```
...
#inspect density of between/within community ties
print(blockmodel(gotmarr.stat, got.eigen$membership)$block.model,
      digits = 2)
#add community membership as a vertex attribute
...
mods
#compare community partitions
compare.algs(alg.a = c("got.fg", "got.wt", "got.lab", "got.edge"),
             alg.b = "got.eigen")

#alliances
alliances.eigen <- leading.eigenvector.community(alliances.ig)
igraph::groups(alliances.eigen)
print(blockmodel(alliances.stat, alliances.eigen$membership)$block.model,
      digits = 2)
...
compare.algs(
  ...
  alg.b = "alliances.eigen"
)

#airport flights
airports.fl.eigen <- leading.eigenvector.community(airports.fl.ig)
igraph::groups(airports.fl.eigen)
print(blockmodel(airports.fl.stat, airports.fl.eigen$membership)$block.model,
      digits = 2)
...
print(
  blockmodel(airports.geo.stat, airports.geo.eigen$membership)$block.model,
  digits = 2
)
...
```{r}
#inspect density of between/within community ties
print(blockmodel(flomarr.stat, comm.spin$membership)$block.model,
      digits = 2)
#add community membership as a vertex attribute
flomarr.nodes$comm.spin[which(flomarr.nodes$name %in% V(flomarr.giant)$name)] <-
  comm.spin$membership
#summarize node statistics by community
...
#inspect density of between/within community ties
print(blockmodel(gotmarr.stat, got.spin$membership)$block.model,
      digits = 2)
#add community membership as a vertex attribute
...
#compare community partitions
compare.algs(
  alg.a = c("got.fg", "got.wt", "got.lab", "got.edge", "got.eigen"),
  alg.b = "got.spin"
)
...
print(blockmodel(alliances.stat, alliances.spin$membership)$block.model,
      digits = 2)
alliances.nodes$comm.spin[which(alliances.nodes$name %in% V(alliances.giant)$name)] <-
  alliances.spin$membership
...
print(blockmodel(airports.fl.stat, airports.fl.spin$membership)$block.model,
      digits = 2)
...
print(blockmodel(airports.geo.stat, airports.geo.spin$membership)$block.model,
      digits = 2)
